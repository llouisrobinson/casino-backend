...
export const ADMIN_WALLET_KART_BALANCE: number = Number(
  process.env.ADMIN_WALLET_KART_BALANCE
);
export const ADMIN_WALLET_USK_BALANCE: number = Number(
  process.env.ADMIN_WALLET_USK_BALANCE
);
